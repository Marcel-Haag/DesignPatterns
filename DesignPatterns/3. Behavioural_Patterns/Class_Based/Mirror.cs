...
namespace DesignPatterns.BehaviouralPattern.Class_Based
{
    ...
    public class ElementCommand : Command
    {
        public override void Interpret(Mirror context)
        {
            ...
            if (context.Peek() != null) ((Control)context.Peek()).Controls.Add((Control)o);
            context.Push(o);
        }
    ...
    // Applies attributes to the current object. The attributes reflects
    ...
    public class AttributeCommand : Command
    {
        public override void Interpret(Mirror context)
        {
            ...
            SetProperty(context.Peek(), context.Reader.Name,
        ...
        public void SetProperty(object o, string name, string val)
        {
            ...
            {
                MethodInfo m = property.PropertyType.GetMethod("Parse",
                new Type[] { typeof(string) });
                object newval = m.Invoke(null /*static */, new object[]
                { val });
