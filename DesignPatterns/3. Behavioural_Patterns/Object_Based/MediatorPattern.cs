...
namespace DesignPatterns.Behavioural_Patterns.Object_Based
{
    class MediatorPattern
    {
        // Mediator Pattern
        /* 
         * The Mediator maintains a list of colleagues 
         * and specifies the communication methods that it can mediate, 
         * in this case, Send. 
         * Receive is implemented at Colleague level 
         * and called via a delegate supplied by the colleagues to the mediator on signon.
         */
        class Mediator
        {
            public delegate void Callback(string message, string from); Callback respond;
        ...
        class Colleague
        {
            ...
            {
                this.mediator = mediator; mediator.SignOn(Receive);
                this.name = name;
            }
            ...
            {
                Console.WriteLine("Send (From " + name + "): " + message); mediator.Send(message, name);
            }
        }
